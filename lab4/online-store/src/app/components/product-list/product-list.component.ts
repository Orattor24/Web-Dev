  ...
  products: Product[] = [
    ...
    },
    {
      ...
      description: 'Детский батут с защитной сеткой 140 см — безопасное и увлекательное решение для активного отдыха ваших детей. Этот батут сочетает в себе высокое качество, удобство и надежность, обеспечивая максимальную защиту во время прыжков.\n' +
        ...
        '- ⚖️ Максимальная нагрузка 100 кг — подходит для активных игр нескольких детей одновременно.\n' +
        '\n' +
        'Этот батут идеально подходит для детей, которые любят активные игры на свежем воздухе. Он станет отличным дополнением к вашему двору или даче, обеспечивая часы веселья и физической активности.',
      price: 15196,
      rating: 4.9,
